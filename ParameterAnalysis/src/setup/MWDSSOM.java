...
public class MWDSSOM extends ExternalClusteringMethod {
    ...
    ClusteringParameter numWinners = new ClusteringParameter(1, "numWinners");
    ClusteringParameter epsilonRho = new ClusteringParameter(0.9, "epsilonRho");
    ClusteringParameter outliers_threshold = new ClusteringParameter(0.995, "outliers_threshold");
...
/**/
    ...
    public String generateCommandString(String fileName) {
        ...
        commandString += " -w " + numWinners.getIntValue();
