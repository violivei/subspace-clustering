 ...
 * @author hans
 */
public class CategorizeImageParametersSOM2DJoint extends MethodParameters{

    CategorizeImagesSOM2DJoint som;

    public CategorizeImageParametersSOM2DJoint(CategorizeImagesSOM2DJoint som) {
        this.som = som;
    ...
    void setupParameterRanges() {
        ...
        addLHSParameter(som.tmax, 10, 500);

        //Codebook
        addLHSParameter(som.nyCB, 5, 200);
        addLHSParameter(som.alphaCB, 0.001, 0.99);
        addLHSParameter(som.lambda2CB, 0.1, 2);
        addLHSParameter(som.sigmaCB, 0.001, 2);
        addLHSParameter(som.lambda1CB, 0.1, 2);
        addLHSParameter(som.tmaxCB, 0.01, 1);
        
        //Codebook audio
        addLHSParameter(som.nyCBA, 5, 200);
        addLHSParameter(som.alphaCBA, 0.001, 0.99);
        addLHSParameter(som.lambda2CBA, 0.1, 2);
        addLHSParameter(som.sigmaCBA, 0.001, 2);
        addLHSParameter(som.lambda1CBA, 0.1, 2);
        addLHSParameter(som.tmaxCBA, 0.01, 1);        
        initLHS(500);
    }
...
//        som.epsilon_dsCB.setValue(	0.007581760	); //-p
    ...
    public static void main(String args[]) {
        ...
        CategorizeImagesSOM2DJoint som = new CategorizeImagesSOM2DJoint();
        CategorizeImageParametersSOM2DJoint somParameters = new CategorizeImageParametersSOM2DJoint(som);
